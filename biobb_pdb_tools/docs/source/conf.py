...
man_pages = [
    (master_doc, "biobb_pdb_tools", "biobb_pdb_tools Documentation", [author], 1)
]
...
texinfo_documents = [
    (
        ...
        author,
        "biobb_pdb_tools",
        "biobb_pdb_tools template building block",
        "Miscellaneous",
    ),
]
