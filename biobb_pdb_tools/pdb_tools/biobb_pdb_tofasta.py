...
def biobb_pdb_tofasta(input_file_path: str, output_file_path: str, properties: dict = None, **kwargs) -> int:
    ...
    return Pdbtofasta(input_file_path=input_file_path, output_file_path=output_file_path, properties=properties, **kwargs).launch()
...
def main():
    ...
    biobb_pdb_tofasta(input_file_path=args.input_file_path, output_file_path=args.output_file_path, properties=properties)
