...
class Delhetatm(BiobbObject):
    ...
    def launch(self) -> int:
        ...
        self.cmd = [self.binary_path, self.stage_io_dict['in']['input_file_path'], '>', self.io_dict['out']['output_file_path']]
...
def biobb_pdb_delhetatm(input_file_path: str, output_file_path: str, properties: Optional[dict] = None, **kwargs) -> int:
    ...
    return Delhetatm(input_file_path=input_file_path, output_file_path=output_file_path, properties=properties, **kwargs).launch()
...
def main():
    ...
    biobb_pdb_delhetatm(input_file_path=args.input_file_path, output_file_path=args.output_file_path, properties=properties)
