...
def biobb_pdb_merge(input_file_path: str, output_file_path: str, properties: Optional[dict] = None, **kwargs) -> int:
    ...
    return Pdbmerge(input_file_path=input_file_path,
...
def main():
    ...
    biobb_pdb_merge(input_file_path=args.input_file_path, output_file_path=args.output_file_path, properties=properties)
