...
class TestPdbSelModel():
    def setup_class(self):
        fx.test_setup(self, 'biobb_pdb_selmodel')

    def teardown_class(self):
        fx.test_teardown(self)
        pass

    def test_pdb_selmodel(self):
        returncode = biobb_pdb_selmodel(properties=self.properties, **self.paths)
